...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
        ...
        <div id="jsstadmin-head">
            ...
            <a title="<?php echo esc_attr(__('Add','js-support-ticket')); ?>" class="jsstadmin-add-link button" href="?page=status&jstlay=addstatus"><img alt = "<?php echo esc_attr(__('Add','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/plus-icon.png" /><?php echo esc_html(__('Add Ticket Status', 'js-support-ticket')); ?></a>
        </div>
            ...
            <?php if (!empty(jssupportticket::$jsst_data[0])) { ?>
                <form class="jsstadmin-form" method="post" action="<?php echo esc_url(wp_nonce_url(admin_url("admin.php?page=jssupportticket&task=saveordering"),"save-ordering")); ?>">
                    <table id="js-support-ticket-table">
                        ...
                        foreach (jssupportticket::$jsst_data[0] AS $jsst_status) {
                            ?>

                            <tr id="id_<?php echo esc_attr($jsst_status->id); ?>">
                                ...
                                <td class="left">
                                    ...
                                    <a title="<?php echo esc_attr(__('Status','js-support-ticket')); ?>" href="?page=status&jstlay=addstatus&jssupportticketid=<?php echo esc_attr($jsst_status->id); ?>">
                                        <?php echo esc_html(jssupportticket::JSST_getVarValue($jsst_status->status)); ?>
                                    </a>
                                </td>
                                <td>
                                    <span class="js-support-ticket-table-responsive-heading">
                                    ...
                                    <span class="js-ticket-admin-prirrity-color" style="background:<?php echo esc_attr($jsst_status->statuscolour); ?>;color:#ffffff;">
                                        <?php echo esc_html($jsst_status->statuscolour); ?>
                                    </span>
                                </td>
                                <td>
                                    <span class="js-support-ticket-table-responsive-heading">
                                    ...
                                    <span class="js-ticket-admin-prirrity-color" style="background:<?php echo esc_attr($jsst_status->statusbgcolour); ?>;color:#ffffff;">
                                        <?php echo esc_html($jsst_status->statusbgcolour); ?>
                                    </span>
                                </td>
                                <td>

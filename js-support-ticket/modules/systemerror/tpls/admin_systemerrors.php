...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
        ...
        <div id="jsstadmin-head">
            ...
            <a class="jsstadmin-add-link button" onclick="return confirm('<?php echo esc_js(__('Are you sure you want to delete it?', 'js-support-ticket')); ?>');" href="<?php echo esc_url(wp_nonce_url('?page=systemerror&task=deletesystemerror&action=jstask&systemerrorid=all','delete-systemerror-all'));?>"><img alt = "<?php echo esc_attr(__('Add','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/delete.png" /><?php echo esc_html(__('Remove All', 'js-support-ticket')); ?></a>
        </div>
                ...
                <table id="js-support-ticket-table">
                    ...
                    foreach (jssupportticket::$jsst_data[0] AS $jsst_systemerror) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a title="<?php echo esc_attr(__('Delete','js-support-ticket')); ?>" class="action-btn" onclick="return confirm('<?php echo esc_js(__('Are you sure you want to delete it?', 'js-support-ticket')); ?>');" href="<?php echo esc_url(wp_nonce_url('?page=systemerror&task=deletesystemerror&action=jstask&systemerrorid='.esc_attr($jsst_systemerror->id),'delete-systemerror-'.$jsst_systemerror->id));?>"><img alt = "<?php echo esc_attr(__('Delete','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/delete.png" /></a>
                            </td>
                        </tr>
                <?php }
                ?>

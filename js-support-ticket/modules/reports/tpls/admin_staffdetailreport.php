...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
        ...
        <div id="jsstadmin-data-wrp" class="p0 bg-n bs-n">
			...
			?>
			<a href="<?php echo esc_url(admin_url('admin.php?page=reports&jstlay=staffdetailreport&id='.esc_attr($jsst_agent->id).'&date_start='.esc_attr(jssupportticket::$jsst_data['filter']['date_start']).'&date_end='.esc_attr(jssupportticket::$jsst_data['filter']['date_end']))); ?>"></a>
						...
						<div class="js-admin-staff-wrapper">
							<div class="js-admin-staff-cnt">
								<div class="js-report-staff-image">
									...
									?>
									<img alt = "<?php echo esc_attr(__('agent image','js-support-ticket')); ?>" class="js-report-staff-pic" src="<?php echo esc_url($jsst_imageurl); ?>" />
								</div>
								...
								<div class="js-ticket-count">
									...
									<?php if(in_array('feedback', jssupportticket::$_active_addons)){ ?>
										<div class="js-ticket-link <?php echo esc_attr($jsst_rating_class)?>">
											<a href="#" class="js-ticket-link js-ticket-mariner" title="<?php echo esc_attr(__('Average Rating', 'js-support-ticket')); ?>">
			...
			<div class="js-admin-report">
						 ...
						 ?>
							<tr>
								<td class="overflow left">
									...
									<a title="<?php echo esc_attr(__('Ticket', 'js-support-ticket')); ?>" target="_blank" href="<?php echo esc_url(admin_url('admin.php?page=ticket&jstlay=ticketdetail&jssupportticketid='.esc_attr($jsst_ticket->id))); ?>"><?php echo esc_html($jsst_ticket->subject); ?></a>
								<?php
								if($jsst_agent->id != $jsst_ticket->staffid){
									$jsst_show_flag = 1;
									?>
								...
								<td>
									...
									<span style="background-color:<?php echo esc_attr($jsst_ticket->prioritycolour); ?>;" class="js-tkt-rep-prty"><?php echo esc_html(jssupportticket::JSST_getVarValue($jsst_ticket->priority)); ?></span>
								</td>
								<td >
									<span class="js-support-ticket-table-responsive-heading"><?php echo esc_html(__("Created","js-support-ticket"));?>: </span>
									<?php echo esc_html(date_i18n(jssupportticket::$_config['date_format'],strtotime($jsst_ticket->created))); ?>
								</td>
								<?php if(in_array('feedback', jssupportticket::$_active_addons)){ ?>
									<td >
				...
				if($jsst_show_flag == 1){ ?>
					<div class="js-form-button">
				        <?php echo '<font style="color:#1C6288;font-size:20px;margin:0px 5px;">*</font>'. esc_html(__('Tickets not assigned to the agent','js-support-ticket')); ?>
			        </div>
			        <?php
			    }
				if(!empty(jssupportticket::$jsst_data['staff_tickets'])){

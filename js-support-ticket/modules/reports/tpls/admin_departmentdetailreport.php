...
$link_export = admin_url('admin.php?page=export&task='.esc_attr($t_name).'&action=jstask&id='.jssupportticket::$_data['filter']['id'].'&date_start='.jssupportticket::$_data['filter']['date_start'].'&date_end='.jssupportticket::$_data['filter']['date_end']);
?>
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
        ...
        <div id="jsstadmin-data-wrp" class="p0 bg-n bs-n">
		    <a href="<?php echo esc_url(admin_url('admin.php?page=reports&jstlay=departmentdetailreport&id='.esc_attr($department->id).'&date_start='.jssupportticket::$_data['filter']['date_start'].'&date_end='.jssupportticket::$_data['filter']['date_end'])); ?>"></a>
			<form class="js-filter-form js-report-form" name="jssupportticketform" id="jssupportticketform" method="post" action="<?php echo esc_url(wp_nonce_url(admin_url("admin.php?page=reports&jstlay=departmentdetailreport&id=".esc_attr($department->id)),"reports")); ?>">
			    <?php
					...
					<div class="js-admin-staff-cnt">
						<div class="js-report-staff-cnt">
							<div class="js-report-staff-info js-report-staff-name">
								<?php
									echo esc_html($department->departmentname);
								?>
							</div>
							<div class="js-report-staff-info js-report-staff-email">
								<?php
									echo esc_html($department->email);
								?>
							</div>
						</div>
					</div>
						        ...
						        <a class="js-ticket-link js-ticket-green" href="#" data-tab-number="1" title="<?php echo esc_html(__('Open Ticket','js-support-ticket')); ?>">
						            ...
						            <div class="js-ticket-link-text js-ticket-green">
						                <?php
						                    ...
						                    echo ' ( '.esc_html($department->openticket).' )';
						                ?>
						            </div>
						        </a>
						    </div>
						        ...
						        <a class="js-ticket-link js-ticket-brown" href="#" data-tab-number="2" title="<?php echo esc_html(__('answered ticket','js-support-ticket')); ?>">
						            ...
						            <div class="js-ticket-link-text js-ticket-brown">
						                <?php
						                    ...
						                    echo ' ( '. esc_html($department->answeredticket).' )';
						                ?>
						            </div>
						        </a>
						    </div>
			                    ...
			                    <a class="js-ticket-link js-ticket-blue" href="#" data-tab-number="3" title="<?php echo esc_html(__('pending ticket','js-support-ticket')); ?>">
			                        ...
			                        <div class="js-ticket-link-text js-ticket-blue">
			                            <?php
			                                ...
			                                echo ' ( '. esc_html($department->pendingticket).' )';
			                            ?>
			                        </div>
			                    </a>
			                </div>
						        ...
						        <a class="js-ticket-link js-ticket-orange" href="#" data-tab-number="4" title="<?php echo esc_html(__('overdue ticket','js-support-ticket')); ?>">
						            ...
						            <div class="js-ticket-link-text js-ticket-orange">
						                <?php
						                    ...
						                    echo ' ( '. esc_html($department->overdueticket).' )';
						                ?>
						            </div>
						        </a>
						    </div>
						        ...
						        <a class="js-ticket-link js-ticket-red" href="#" data-tab-number="5" title="<?php echo esc_html(__('Close Ticket','js-support-ticket')); ?>">
						            ...
						            <div class="js-ticket-link-text js-ticket-red">
						                <?php
						                    ...
						                    echo ' ( '. esc_html($department->closeticket).' )';
						                ?>
						            </div>
						        </a>
						    </div>
			...
			<div class="js-admin-report">
				...
				if(!empty(jssupportticket::$_data['department_tickets'])){ ?>
					...
					foreach(jssupportticket::$_data['department_tickets'] AS $ticket){ 
						...
						<tr>
							<td class="left">
								<a target="_blank" href="<?php echo esc_url(admin_url('admin.php?page=ticket&jstlay=ticketdetail&jssupportticketid='.esc_attr($ticket->id))); ?>" title="<?php echo esc_html(__('Department','js-support-ticket')); ?>">

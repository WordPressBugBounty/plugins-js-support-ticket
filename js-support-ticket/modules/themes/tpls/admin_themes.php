    ...
    <div id="jsstadmin-data">
        ...
        <div id="jsstadmin-data-wrp" class="">
            ...
            <div class="js_effect_preview">
                <span class="js_effect_preview_heading" style="text-align:center;font-size:30px;"><?php echo esc_html(__('Color Effect Preview Coming Soon', 'js-support-ticket')); ?></span>
            </div>

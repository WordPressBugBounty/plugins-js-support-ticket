...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
    	...
    	<div id="jsstadmin-head">
            ...
            <a target="blank" href="https://www.youtube.com/watch?v=mN6xsD2u2CI" class="jsstadmin-add-link black-bg button js-cp-video-popup" title="<?php echo esc_attr(__('Watch Video', 'js-support-ticket')); ?>">
    	...
    	<div id="jsstadmin-data-wrp" class="p0">
			...
			<?php if(in_array('multiform', jssupportticket::$_active_addons)){ ?>
				<div id="jsst-shortcode-wrapper">
					...
					<?php 
						$jsst_multiforms = jssupportticket::$jsst_data[0]['multiforms'];
						foreach ($jsst_multiforms as $jsst_multiform) {
						 	echo '<div class="jsst-shortcode-2">
						 		[jssupportticket_addticket_multiform formid='.esc_attr($jsst_multiform->id).']';
					 			echo '<span class="jsst-shortcode-name">('.esc_html($jsst_multiform->title).'</span>';
						 		if (isset($jsst_multiform->departmentname)) {
						 			echo '<span class="jsst-shortcode-dept"> - '.esc_html($jsst_multiform->departmentname).')</span>';
						 		} else {
			...
			<?php if(in_array('download', jssupportticket::$_active_addons)){ ?>
				...
				<div id="jsst-shortcode-wrapper">
					...
					<div class="jsst-shortcode-3"><?php echo esc_html(__("Show latest downloads. Options",'js-support-ticket')).': text_color="'.esc_attr($jsst_color3).'" '. esc_html(__("and",'js-support-ticket')).' background_color="'.esc_attr($jsst_color1).'" '. esc_html(__("i.e.",'js-support-ticket')).' [jssupportticket_downloads_latest text_color="'.esc_attr($jsst_color3).'" background_color="'.esc_attr($jsst_color1).'"]'; ?></div>
				</div>
				<div id="jsst-shortcode-wrapper">
					...
					<div class="jsst-shortcode-3"><?php echo esc_html(__("Show popular downloads. Options",'js-support-ticket')).': text_color="'.esc_attr($jsst_color3).'" '. esc_html(__("and",'js-support-ticket')).' background_color="'.esc_attr($jsst_color1).'" '. esc_html(__("i.e.",'js-support-ticket')).' [jssupportticket_downloads_popular text_color="'.esc_attr($jsst_color3).'" background_color="'.esc_attr($jsst_color1).'"]'; ?></div>
				</div>
			<?php } ?>
			...
			<?php if(in_array('announcement', jssupportticket::$_active_addons)){ ?>
				...
				<div id="jsst-shortcode-wrapper">
					...
					<div class="jsst-shortcode-3"><?php echo esc_html(__("Show latest announcements. Options",'js-support-ticket')).': text_color="'.esc_attr($jsst_color3).'" '. esc_html(__("and",'js-support-ticket')).' background_color="'.esc_attr($jsst_color1).'" '. esc_html(__("i.e.",'js-support-ticket')).' [jssupportticket_announcements_latest text_color="'.esc_attr($jsst_color3).'" background_color="'.esc_attr($jsst_color1).'"]'; ?></div>
				</div>
				<div id="jsst-shortcode-wrapper">
					...
					<div class="jsst-shortcode-3"><?php echo esc_html(__("Show popular announcements. Options",'js-support-ticket')).': text_color="'.esc_attr($jsst_color3).'" '. esc_html(__("and",'js-support-ticket')).' background_color="'.esc_attr($jsst_color1).'" '. esc_html(__("i.e.",'js-support-ticket')).' [jssupportticket_announcements_popular text_color="'.esc_attr($jsst_color3).'" background_color="'.esc_attr($jsst_color1).'"]'; ?></div>
				</div>
			<?php } ?>
		</div>
	</div>

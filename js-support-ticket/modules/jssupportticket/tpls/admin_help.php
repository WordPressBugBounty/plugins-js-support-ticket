    		...
    		<div class="jssticketadmin-help-top">
    			<div class="jssticketadmin-help-top-left">
    				<div class="jssticketadmin-help-top-left-cnt-img">
    					<img alt = "<?php echo esc_attr(__('Help icon','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/support-icon.jpg" />
    				</div>
    			...
    			<div class="jssticketadmin-help-top-right">
    				<div class="jssticketadmin-help-top-right-cnt-img">
    					<img alt = "<?php echo esc_attr(__('Help Desk icon','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/support.png" />
    				</div>
    			...
    			<div class="jssticketadmin-help-btm-wrp">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=Yi3zPvGdGG4" class="jssticketadmin-help-btm-link"  target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to set ticket auto close','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=S7KWbUHvmmk" class="jssticketadmin-help-btm-link"  target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to reopen closed ticket','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=p3vT2vhSkjk" class="jssticketadmin-help-btm-link"  target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to add private note','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=SW9b9lBthbc" class="jssticketadmin-help-btm-link"  target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('View ticket history','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=c7whQ6F70yM" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to setup custom fields','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=CQRgkw3e5KQ" class="jssticketadmin-help-btm-link"  target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('Set ticket auto overdue','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=xziaXK3DKCM" class="jssticketadmin-help-btm-link"  target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('Manually set ticket overdue','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=HnnJTe6lYc4" class="jssticketadmin-help-btm-link"  target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to merge tickets','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=Q8GhQQmeMU4" class="jssticketadmin-help-btm-link"  target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to export tickets','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=-eh4XuDwXoY" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How use help topic','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=hewCQ0S37V8" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to change department','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=gmI25bv5cGA" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to use multi-forms','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=3ndoMZ760Fk" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to paid support','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=RBbmVEkE14E" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to use canned response','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=iKslva_FkTg" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to add private credentials','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=yZi_BRyAQl8" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to ban/unban user','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                ...
                <div class="jssticketadmin-help-btm-wrp">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=hOvN-_6Qf8g" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('Agent system','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                            <a href="https://www.youtube.com/watch?v=1J0JSXrr1hY" class="jssticketadmin-help-btm-link" target="_blank">
                                <div class="jssticketadmin-help-btm-cnt-img">
                                    <img alt = "<?php echo esc_attr(__('How to edit time','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                                </div>
                                <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=oSzJz9FDzsY" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to use time tracking','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
    			...
    			<div class="jssticketadmin-help-btm-wrp">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=SJjHk50buw0" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to set max open ticket','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
    				...
    				<div class="jssticketadmin-help-btm-cnt">
    					<a href="https://www.youtube.com/watch?v=9ORIFf6jPPg" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to show counts','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=-78pMXbZy8o" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to set Captcha','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
    				...
    				<div class="jssticketadmin-help-btm-cnt">
    					<a href="https://www.youtube.com/watch?v=T3HRojY2UN4" class="jssticketadmin-help-btm-link" target="_blank">
                             <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('User options','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
    				...
    				<div class="jssticketadmin-help-btm-cnt">
    					<a href="https://www.youtube.com/watch?v=Hq1UzmUqFIA" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to set login redirect','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
    				...
    				<div class="jssticketadmin-help-btm-cnt">
    					<a href="https://www.youtube.com/watch?v=qloE9WQM4rE" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to set fields ordering','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
    				...
    				<div class="jssticketadmin-help-btm-cnt">
    					<a href="https://www.youtube.com/watch?v=jyM4iW8uROY" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to enable social login','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
    			...
    			<div class="jssticketadmin-help-btm-wrp">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=Honmzw892ZE" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to setup','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=6qjMe1Ppbck" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to enable email piping','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=4_wrnx8ka0E" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to set SMTP','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=Nnu2iJQ99Tk" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to translate','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
    				...
    				<div class="jssticketadmin-help-btm-cnt">
    					<a href="https://www.youtube.com/watch?v=oOOr869FOyA" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to set colors','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=K0K6vEANnRU" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to install addons','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                ...
                <div class="jssticketadmin-help-btm-wrp jssticketadmin-help-sub-category">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=sQBflPjxPEw" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to use knowledge base','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=6-WfiCXB0ZM" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to use downloads','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=XhWXu2RlFds" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to add announcement','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=lF58MTzV2aQ" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to create FAQ','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                ...
                <div class="jssticketadmin-help-btm-wrp">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=kiNyGRqXtAs" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to use email cc','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=a5eXxHLB7qU" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to use internal mail','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=pdIRcBgtxjw" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('Use front-end widgets','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">
                    ...
                    <div class="jssticketadmin-help-btm-cnt">
                        <a href="https://www.youtube.com/watch?v=t0VUBYDmKpU" class="jssticketadmin-help-btm-link" target="_blank">
                            <div class="jssticketadmin-help-btm-cnt-img">
                                <img alt = "<?php echo esc_attr(__('How to enable admin widgets','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/help-page/video-icon.jpg" />
                            </div>
                            <div class="jssticketadmin-help-btm-cnt-title">

    ...
    <div id="jsstadmin-data">
        ...
        <div id="jsstadmin-data-wrp" class="p0 bg-n bs-n">
            <form class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="post" action="<?php echo esc_url(wp_nonce_url(admin_url("admin.php?page=gdpr&jstlay=erasedatarequests"),"erase-data-requests")); ?>">
                <?php echo wp_kses(JSSTformfield::text('email', jssupportticket::$jsst_data['filter']['email'], array('placeholder' => esc_html(__('User Email', 'js-support-ticket')),'class' => 'js-form-input-field')), JSST_ALLOWED_TAGS); ?>
            ...
            <?php if (!empty(jssupportticket::$jsst_data[0])) { ?>
                <table id="js-support-ticket-table">
                    ...
                    <?php
                    foreach (jssupportticket::$jsst_data[0] AS $jsst_request) {
                        ?>
                        <tr>
                            <td class="left">
                                ...
                                <?php echo esc_html($jsst_request->subject); ?>
                            </td>
                            <td class="left">
                                <span class="js-support-ticket-table-responsive-heading">
                                    <?php echo esc_html(__('Message','js-support-ticket'));echo " : "; ?>
                                </span>
                                <?php echo wp_kses($jsst_request->message, JSST_ALLOWED_TAGS); ?>
                            </td>
                            <td>
                                <span class="js-support-ticket-table-responsive-heading">
                                    <?php echo esc_html(__('Email', 'js-support-ticket')); echo " : "; ?>
                                </span>
                                <?php echo esc_html($jsst_request->user_email); ?>
                            </td>
                            <td>
                                <span class="js-support-ticket-table-responsive-heading">
                            ...
                            <td>
                                ...
                                <?php echo esc_html(date_i18n(jssupportticket::$_config['date_format'], jssupportticketphplib::JSST_strtotime($jsst_request->created))); ?>
                            </td>
                            <td>
                ...
                if (jssupportticket::$jsst_data[1]) {
                    echo '<div class="tablenav"><div class="tablenav-pages" style="margin: 1em 0">' . wp_kses_post(jssupportticket::$jsst_data[1]) . '</div></div>';
                }
            } else {

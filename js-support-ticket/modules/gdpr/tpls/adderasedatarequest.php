...
<div class="jsst-main-up-wrapper">
    ...
    if (jssupportticket::$_config['offline'] == 2) {
        if (JSSTincluder::getObjectClass('user')->uid() != 0) {
            ...
            $jsst_formdata = JSSTformfield::getFormData();
        } ?>
        ...
        if (JSSTincluder::getObjectClass('user')->uid() != 0) { ?>
            ...
            <?php if(isset(jssupportticket::$jsst_data[0]) && !empty(jssupportticket::$jsst_data[0])) { ?>
            ...
            <?php } ?>
                ...
                <form class="js-ticket-form" method="post" action="<?php echo esc_url(wp_nonce_url(jssupportticket::makeUrl(array('jstmod'=>'gdpr', 'task'=>'saveusereraserequest')),"save-usereraserequest-".$jsst_nonce_id)); ?>">
                    <div class="js-ticket-from-field-wrp js-ticket-from-field-wrp-full-width">
                        ...
                        <div class="js-ticket-from-field">
                            <?php
                                ...
                                echo wp_kses(JSSTformfield::text('subject', $jsst_subject, array('class' => 'inputbox js-ticket-form-field-input', 'data-validation' => 'required')), JSST_ALLOWED_TAGS);
                            ?>
                        </div>
                    </div>
                    <div class="js-ticket-from-field-wrp js-ticket-from-field-wrp-full-width">
                        ...
                        <div class="js-ticket-from-field">
                            <?php wp_editor(isset(jssupportticket::$jsst_data[0]->message) ? jssupportticket::$jsst_data[0]->message : '', 'message', array('media_buttons' => false)); ?>
                        </div>
                    </div>

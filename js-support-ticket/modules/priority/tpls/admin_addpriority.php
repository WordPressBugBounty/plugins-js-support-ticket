        ...
        <div id="jsstadmin-data-wrp">
            ...
            <form class="jsstadmin-form" method="post" action="<?php echo esc_url(wp_nonce_url(admin_url("?page=priority&task=savepriority"),"save-priority-".$jsst_nonce_id)); ?>">
                <div class="js-form-wrapper">
                    ...
                    <div class="js-form-value"><?php echo wp_kses(JSSTformfield::text('priority', isset(jssupportticket::$jsst_data[0]->priority) ? jssupportticket::$jsst_data[0]->priority : '', array('class' => 'inputbox js-form-input-field', 'data-validation' => 'required')), JSST_ALLOWED_TAGS) ?></div>
                </div>
                <div class="js-form-wrapper">
                    ...
                    <div class="js-form-value">
                        <?php
                        $jsst_style = '';
                        if (!empty(jssupportticket::$jsst_data[0]->prioritycolour)) {
                            $jsst_style = "background:".jssupportticket::$jsst_data[0]->prioritycolour;
                        } ?>
                        <span style="<?php echo esc_attr($jsst_style); ?>" class="js-form-prioritycolor-wrp"></span>
                        <?php echo wp_kses(JSSTformfield::text('prioritycolor', isset(jssupportticket::$jsst_data[0]->prioritycolour) ? jssupportticket::$jsst_data[0]->prioritycolour : '', array('class' => 'inputbox js-form-input-field js-form-prioritycolor-field', 'data-validation' => 'required', 'autocomplete' => 'off')), JSST_ALLOWED_TAGS); ?>
                    </div>
                </div>
                <?php if(in_array('overdue', jssupportticket::$_active_addons)){ ?>
                    <div class="js-form-wrapper">
                        ...
                        <div class="js-form-value"><?php echo wp_kses(JSSTformfield::select('overduetypeid', $jsst_dayshours , (isset(jssupportticket::$jsst_data[0]->overduetypeid) ? jssupportticket::$jsst_data[0]->overduetypeid : '' ), '',array('class' => 'inputbox js-form-select-field')), JSST_ALLOWED_TAGS)?></div>
                    </div>
                    <div class="js-form-wrapper">
                        <div class="js-form-title"><?php echo esc_html(__('Ticket Overdue', 'js-support-ticket')); ?></div>
                        <div class="js-form-value"><?php echo wp_kses(JSSTformfield::text('overdueinterval', isset(jssupportticket::$jsst_data[0]->overdueinterval) ? jssupportticket::$jsst_data[0]->overdueinterval : '', array('class' => 'inputbox js-form-input-field')), JSST_ALLOWED_TAGS) ?><span class="ticket_overdue_type_text" ><?php echo isset(jssupportticket::$jsst_data[0]->overduetypeid) ? esc_html(jssupportticket::$jsst_data[0]->overduetypeid) : '' ?></span></div>
                    </div>
                <?php } ?>
                <div class="js-form-wrapper">
                    <div class="js-form-title"><?php echo esc_html(__('Public', 'js-support-ticket')); ?></div>
                    <div class="js-form-value"><?php echo wp_kses(JSSTformfield::radiobutton('ispublic', array('1' => esc_html(__('Yes', 'js-support-ticket')), '0' => esc_html(__('No', 'js-support-ticket'))), isset(jssupportticket::$jsst_data[0]->ispublic) ? jssupportticket::$jsst_data[0]->ispublic : '1', array('class' => 'radiobutton')), JSST_ALLOWED_TAGS); ?></div>
                </div>
                <div class="js-form-wrapper">
                    <div class="js-form-title"><?php echo esc_html(__('Default', 'js-support-ticket')); ?></div>
                    <div class="js-form-value"><?php echo wp_kses(JSSTformfield::radiobutton('isdefault', array('1' => esc_html(__('Yes', 'js-support-ticket')), '0' => esc_html(__('No', 'js-support-ticket'))), isset(jssupportticket::$jsst_data[0]->isdefault) &&  jssupportticket::$jsst_data[0]->isdefault == 1 ? 1 : 0, array('class' => 'radiobutton')), JSST_ALLOWED_TAGS); ?></div>
                </div>
                <div class="js-form-wrapper">

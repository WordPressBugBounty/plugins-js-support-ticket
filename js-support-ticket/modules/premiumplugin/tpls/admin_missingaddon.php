...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
            ...
            <div id="jsstadmin-wrapper-top-left">
                <div id="jsstadmin-breadcrunbs">
                    <ul>
                        ...
                        <li><?php echo esc_html(__('Premium Addons','js-support-ticket')); ?></li>
                    </ul>
                </div>
            </div>
        ...
        <div id="jsstadmin-head">
            <h1 class="jsstadmin-head-text"><?php echo esc_html(__("Premium Addons", 'js-support-ticket')); ?></h1>
        </div>
        <div id="jsstadmin-data-wrp">
            <div id="jssupportticket-content">
                <h1 class="jsst-missing-addon-message" >
                    <?php
                    $jsst_addon_name = JSSTrequest::getVar('page');
                    echo esc_html(ucfirst($jsst_addon_name)).'&nbsp;';
                    echo esc_html(__('addon in no longer active','js-support-ticket')).'!';
                    ?>

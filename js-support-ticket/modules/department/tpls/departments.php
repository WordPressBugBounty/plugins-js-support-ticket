                                            ...
                                            foreach (jssupportticket::$jsst_data[0] AS $jsst_department) {
                                                ...
                                                <div class="js-ticket-data-row">
                                                    ...
                                                    <div class="js-ticket-table-body-col js-col-md-2 js-col-xs-2">
                                                        ...
                                                        <a class="js-ticket-table-action-btn" onclick="return confirm('<?php echo esc_js(__('Are you sure you want to delete?', 'js-support-ticket')); ?>');" href="<?php echo esc_url(wp_nonce_url(jssupportticket::makeUrl(array('jstmod'=>'department', 'task'=>'deletedepartment', 'action'=>'jstask', 'departmentid'=>$jsst_department->id, 'jsstpageid'=>get_the_ID())),'delete-department-'.$jsst_department->id)); ?>"><img alt="<?php echo esc_attr(__('image','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/downloadicon/delete.png" /></a>
                                                    </div>
                                                </div>
                                        <?php } ?>
                                    </div>

...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
        ...
        <div id="jsstadmin-head">
            ...
            <a title="<?php echo esc_attr(__('Add','js-support-ticket')); ?>" class="jsstadmin-add-link button" href="?page=email&jstlay=addemail"><img alt = "<?php echo esc_attr(__('Add','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/plus-icon.png" /><?php echo esc_html(__('Add Email', 'js-support-ticket')); ?></a>
            <a target="blank" href="https://www.youtube.com/watch?v=4_wrnx8ka0E" class="jsstadmin-add-link black-bg button js-cp-video-popup" title="<?php echo esc_attr(__('Watch Video', 'js-support-ticket')); ?>">
        ...
        <div id="jsstadmin-data-wrp" class="p0 bg-n bs-n">
            <form class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="post" action="<?php echo esc_url(wp_nonce_url(admin_url("admin.php?page=email&jstlay=emails"),"emails")); ?>">
                <?php echo wp_kses(JSSTformfield::text('email', jssupportticket::$jsst_data['filter']['email'], array('placeholder' => esc_html(__('Email', 'js-support-ticket')),'class' => 'js-form-input-field')), JSST_ALLOWED_TAGS); ?>
            ...
            <table id="js-support-ticket-table">
                ...
                foreach (jssupportticket::$jsst_data[0] AS $jsst_email) {
                    $jsst_autoresponse = ($jsst_email->autoresponse == 1) ? 'good.png' : 'close.png';
                    ?>
                    <tr>
                ...
                echo " : "; ?></span><a title="<?php echo esc_attr(__('Email','js-support-ticket')); ?>" href="?page=email&jstlay=addemail&jssupportticketid=<?php echo esc_attr($jsst_email->id); ?>"><?php echo esc_html($jsst_email->email); ?></a></td>
                        <td><span class="js-support-ticket-table-responsive-heading"><?php echo esc_html(__('Auto Response', 'js-support-ticket'));
                echo " : "; ?></span><img alt = "<?php echo esc_attr(__('Auto Response','js-support-ticket')); ?>" src="<?php echo esc_url(JSST_PLUGIN_URL); ?>includes/images/<?php echo esc_attr($jsst_autoresponse); ?>" /></td>
                        <!-- <td><span class="js-support-ticket-table-responsive-heading"><?php /* echo esc_html(__('Priority','js-support-ticket'));echo " : "; ?></span><?php echo esc_html($jsst_email->priority); */ ?></td> -->

...
if (!defined('ABSPATH'))
	...
	function widget( $args, $instance ) {
		...
		echo wp_kses($before_widget, JSST_ALLOWED_TAGS);
		$mod = "jshelpdeskpages";
		$layoutName = $mod . uniqid();
    	$instance['jsstpageid'] = jssupportticket::getPageid();
		echo '['.wp_kses($instance['jshelpdeskpages'], JSST_ALLOWED_TAGS).']';

		echo wp_kses($after_widget, JSST_ALLOWED_TAGS);
	}
	...
	public function update($new_instance, $old_instance) {
        $instance = array();
        $instance['jshelpdeskpages'] = (!empty($new_instance['jshelpdeskpages']) ) ? jssupportticketphplib::JSST_strip_tags($new_instance['jshelpdeskpages']) : '';
        return $instance;
    }
		...
		?>
			<p>
				...
				<?php if(in_array('faq', jssupportticket::$_active_addons)){ ?>
					<option value="jssupportticket_faqs" <?php echo ( $jshelpdeskpages == 'jssupportticket_faqs' ) ? 'selected="selected"' : false; ?>><?php echo esc_html(__("List FAQs",'js-support-ticket')); ?></option>
					<option value="jssupportticket_faqs_latest" <?php echo ( $jshelpdeskpages == 'jssupportticket_faqs_latest' ) ? 'selected="selected"' : false; ?>><?php echo esc_html(__("Latest FAQs",'js-support-ticket')); ?></option>
					<option value="jssupportticket_faqs_popular" <?php echo ( $jshelpdeskpages == 'jssupportticket_faqs_popular' ) ? 'selected="selected"' : false; ?>><?php echo esc_html(__("Popular FAQs",'js-support-ticket')); ?></option>
				<?php }?>

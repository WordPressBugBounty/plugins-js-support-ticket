...
$jssupportticket_css .= '
	/* Staff Report */
	div.js-ticket-staff-report-wrapper{float: left;width: 100%;padding: 10px;margin: 0 !important;}
	...
	div.js-admin-report-box-wrapper div.js-admin-box div.js-admin-box-content div.js-admin-box-content-label{text-align: right;font-size:14px;padding:0px;margin-top:5px;color:'.$color4.';white-space: nowrap;overflow: hidden;text-overflow:ellipsis;}
	...
	div.js-admin-staff-wrapper div.js-report-staff-image-wrapper{height: 100px;width: 100px;border-radius: 100%;text-align: center;line-height: 92px;float: left;border-radius: 100%;}
	div.js-admin-staff-wrapper div.js-report-staff-image-wrapper img.js-report-staff-pic{height: 80px;width: 80px;margin:0 auto;display: inline-block;border-radius: 100%;}
	div.js-admin-staff-wrapper div.js-report-staff-cnt-wrapper {float: left;width: calc(100% - 100px);padding: 6px 0 0 10px;}
	div.js-admin-staff-wrapper div.js-festaffreport-data {float: left;width: 60%;}

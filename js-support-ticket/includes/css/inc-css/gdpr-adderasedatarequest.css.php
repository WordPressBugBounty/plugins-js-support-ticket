...
$jssupportticket_css .= '
	...
	form.js-ticket-form{display:inline-block; width: 100%; padding: 20px 0 10px;}
	...
	div.js-ticket-add-form-wrapper div.js-ticket-from-field-wrp div.js-ticket-from-field.js-ticket-from-field-wrp-full-width select#status{float: left;width: 100%;border-radius: 0px;background: url('.esc_url(JSST_PLUGIN_URL).'includes/images/selecticon.png) 98% / 2% no-repeat;padding: 10px;line-height: initial;height: 50px;}
	div.js-ticket-add-form-wrapper div.js-ticket-from-field-wrp.js-ticket-from-field-wrp-full-width div.js-ticket-from-field select#status{float: left;width: 100%;border-radius: 0px;background: url('.esc_url(JSST_PLUGIN_URL).'includes/images/selecticon.png) 98% / 2% no-repeat;padding: 10px;line-height: initial;height: 50px;}
	...
	div.js-ticket-top-search-wrp.second-style{float: left;width: 100%;}
	div.js-ticket-search-heading-wrp{float: left;width: 100%; padding: 10px;}
	div.js-ticket-search-heading-wrp div.js-ticket-heading-left{float: left;width: 70%;padding: 15px 10px;line-height: initial;}
	div.js-ticket-search-heading-wrp div.js-ticket-heading-right{float: left;width: 30%;text-align: right;}
	div.js-ticket-search-heading-wrp div.js-ticket-heading-right a.js-ticket-add-download-btn{display: inline-block;padding: 15px 25px;text-decoration: none;outline: 0px;line-height: initial;}
	...
	div.js-ticket-top-search-wrp.second-style{margin-top:20px;}
...
/* Add Form */
	...
	div.js-ticket-form-btn-wrp input.js-ticket-save-button{background-color:'.$color2.' !important;color:'.$color7.' !important;}
	...
	div.js-ticket-search-heading-wrp{background-color: '.$color2.';color: '.$color7.';}
	div.js-ticket-search-heading-wrp div.js-ticket-heading-right a.js-ticket-add-download-btn{background: #fff;color: '.$color2.';}
	div.js-ticket-search-heading-wrp div.js-ticket-heading-right a.js-ticket-add-download-btn:hover{color: '.$color1.';}

	div.js-ticket-search-heading-wrp.second-style{background-color: '.$color3.';color: '.$color2.';}
	div.js-ticket-search-heading-wrp.second-style div.js-ticket-heading-right a.js-ticket-add-download-btn{background: '.$color4.';color: '.$color7.';}

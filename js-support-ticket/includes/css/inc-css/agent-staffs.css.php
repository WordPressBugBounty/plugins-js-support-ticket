...
/*Code for Css*/
$jsst_jssupportticket_css .= '
/* Agent/Staff - Matched with Announcement CSS */

    /* General Wrappers - Modern Layout */
    div.js-ticket-staff-wrapper,
...
div.jsst-main-up-wrapper input, div.jsst-main-up-wrapper button, div.jsst-main-up-wrapper select, div.jsst-main-up-wrapper textarea
{
    ...
    /* Staff image (kept from original agent-staffs.css) */
    span.js-ticket-staff-img {
        display: inline-flex;
        width: 40px;
        height: 40px;
        margin: 0;
    ...
    span.js-ticket-staff-img img.jsticketstafflogo{
        max-width: 100%;
        height: auto;
        border-radius: 50%;
    }
...
$jsst_jssupportticket_css .= '
	...
	div.js-ticket-staff-wrapper div.js-ticket-table-body div.js-ticket-data-row {border:1px solid' . $jsst_color5 . ';}
';

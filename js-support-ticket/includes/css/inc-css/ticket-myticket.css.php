...
div.js-ticket-search-wrp div.js-ticket-form-wrp form.js-filter-form div.js-filter-field-wrp .js-form-cust-ckb-fld-wrp .js-ticket-check-box input[type="checkbox"]{
        ...
        height: 11px;
        border: 1px solid ' . $color2 . '; /* Border with secondary color */
...
/* My Tickets */
    /* Top Circle Count Box*/
        ...
        div.js-myticket-link a.js-myticket-link div.progress::after {border: 25px solid '. $color5 .';} /* Lighter grey for progress background */

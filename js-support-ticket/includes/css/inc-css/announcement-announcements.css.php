...
/* Annoucement */
	...
	div.js-ticket-fields-wrp div.js-ticket-form-field input.js-ticket-field-input{float: left;width: 100%;border-radius: 0px; padding: 10px;height: 50px;line-height: initial;}
	
	select.js-ticket-select-field{float: left;width: 100%;border-radius: 0px;background: url('.esc_url(JSST_PLUGIN_URL).'includes/images/selecticon.png) 96% / 4% no-repeat #eee; }
	...
	div.js-ticket-categories-content div.js-ticket-category-box a.js-ticket-category-title{display: inline-block;text-decoration: none;outline: 0px;width: 100%;padding: 0px;float: left;}
	...
	div.js-ticket-downloads-wrp div.js-ticket-downloads-heading-wrp{float: left;width: 100%;padding: 15px;}
...
$jssupportticket_css .= '
	...
	div.js-ticket-search-heading-wrp{background-color: '.$color3.';color: '.$color2.';}
	...
	div.js-ticket-fields-wrp div.js-ticket-form-field input.js-ticket-field-input{background-color: #fff;border:1px solid  '.$color5.';color: '.$color2.';}
	...
	div.js-ticket-categories-content div.js-ticket-category-box{background-color: #fff;border:1px solid  '.$color5.';color: '.$color2.';}

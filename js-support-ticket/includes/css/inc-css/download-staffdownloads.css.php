...
/* Downloads */
    ...
    /* Attachment-specific styles (kept from original) */
...
$jsst_jssupportticket_css .= '
    ...
    div.js-ticket-search-form-btn-wrp input.js-search-button, input#jsst-go {background: ' . $jsst_color1 . ' !important;color: ' . $jsst_color7 . ' !important;}
    div.js-ticket-search-form-btn-wrp input.js-search-button:hover, input#jsst-go:hover {background: ' . $jsst_color2 . ' !important;color: ' . $jsst_color7 . ' !important;}
    ...
    div.js-ticket-download-wrapper div.js-ticket-table-body div.js-ticket-data-row {border:1px solid' . $jsst_color5 . ';}

    /* Attachment-specific colors (kept from original) */

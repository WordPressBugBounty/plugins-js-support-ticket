...
$jssupportticket_css .= '
    ...
    div.js-ticket-search-form-btn-wrp input.js-search-button, input#jsst-go {background: ' . $color1 . ' !important;color: ' . $color7 . ' !important;}
    div.js-ticket-search-form-btn-wrp input.js-search-button:hover, input#jsst-go:hover {background: ' . $color2 . ' !important;color: ' . $color7 . ' !important;}
    ...
    div.js-ticket-download-wrapper div.js-ticket-table-body div.js-ticket-data-row {border:1px solid' . $color5 . ';}

...
/*Code for Css*/
$jsst_jssupportticket_css .= '
/* Canned Responses - Matched with Announcement CSS */

    /* General Wrappers - Modern Layout */
    div.js-ticket-cannedresponses-wrapper, /* Assuming a unique wrapper */
...
div.jsst-main-up-wrapper input, div.jsst-main-up-wrapper button, div.jsst-main-up-wrapper select, div.jsst-main-up-wrapper textarea
{
    ...
    .jsst-main-up-wrapper select{-webkit-appearance:none !important;}
    .jsst-main-up-wrapper select{
    border-radius:8px;
    }
';
...
$jsst_jssupportticket_css .= '
    ...
    div.js-ticket-fields-wrp div.js-ticket-form-field input.js-ticket-field-input, div.js-ticket-fields-wrp div.js-ticket-form-field select.js-ticket-field-input{background-color: #fff;border:1px solid  ' . $jsst_color5 . ';color: ' . $jsst_color4 . ';}

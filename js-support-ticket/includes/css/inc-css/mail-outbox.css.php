...
$jssupportticket_css .= '
	...
	div.js-ticket-add-form-wrapper div.js-ticket-from-field-wrp div.js-ticket-from-field select#to{background: url('.esc_url(JSST_PLUGIN_URL).'includes/images/selecticon.png) 98% / 2% no-repeat;padding: 10px;line-height: initial;height: 60px;}
...
$jssupportticket_css .= '
	...
	span.js-ticket-display-block {color: '.$color2.';}
	...
	div.js-ticket-download-content-wrp div.js-ticket-table-body div.js-ticket-data-row {border:1px solid'.$color5.';}

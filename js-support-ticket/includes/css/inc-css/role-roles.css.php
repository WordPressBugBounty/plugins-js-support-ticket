...
$jssupportticket_css .= '
	...
	div.js-ticket-search-form-btn-wrp-download input.js-search-button{float: left;width: calc(100% / 2 - 10px); padding: 15px 0px;text-align: center;margin: 0px 0px 0px 10px; border-radius: 0px;line-height: initial;height: 50px;}
	div.js-ticket-search-form-btn-wrp-download input.js-reset-button{float: left;width: calc(100% / 2 - 10px); padding: 15px 0px;text-align: center; margin: 0px 0px 0px 10px; border-radius: 0px;line-height: initial;height: 50px;}

	div.js-ticket-download-content-wrp{float: left;width: 100%;margin-top: 30px;}
	div.js-ticket-table-heading-wrp{float: left;width: 100%; padding: 10px;line-height: initial;}
...
div.js-ticket-roles-wrapper div.js-ticket-table-body div.js-ticket-data-row {border:1px solid'.$color5.';}

...
$jssupportticket_css .= '
    ...
    select.js-ticket-select-field, select.js-ticket-field-input {background-color: #fff !important;border:1px solid  ' . $color5 . ';color: ' . $color4 . ';}
    ...
    div.jsst-main-up-wrapper a.js-ticket-table-add-btn{background: ' . $color2 . ';color: ' . $color7 . ';border:1px solid  ' . $color7 . ';}
    div.jsst-main-up-wrapper a.js-ticket-table-add-btn:hover{border-color: ' . $color1 . ';text-decoration: none;color: ' . $color7 . '}
    ...
    a.js-ticket-table-action-btn {border: 1px solid ' . $color5 . ';background: #fff;}
    a.js-ticket-table-action-btn:hover {border-color: ' . $color1 . ';}

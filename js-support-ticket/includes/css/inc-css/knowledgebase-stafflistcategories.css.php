...
/*Code for Css*/
$jssupportticket_css .= '
	div.js-ticket-department-wrapper{float: left;width: 100%;padding: 10px;}
	...
	div.js-ticket-search-form-btn-wrp-download input.js-search-button{float: left;width: calc(100% / 2 - 10px); padding: 13px 0px;text-align: center;margin: 0px 0px 0px 10px; border-radius: 0px;line-height: initial;height: 50px;}
	div.js-ticket-search-form-btn-wrp-download input.js-reset-button{float: left;width: calc(100% / 2 - 10px); padding: 13px 0px;text-align: center; margin: 0px 0px 0px 10px; border-radius: 0px;line-height: initial;height: 50px;}
...
/* Downloads */
	div.js-ticket-top-search-wrp{border:1px solid '.$color5.';background: '.$color3.';}
	...
	div.js-ticket-table-header-wrp{background-color:#ecf0f5;border:1px solid '.$color5.';}

...
<ul class="jsstadmin-sidebar-menu tree accordion">
    ...
    <li class="treeview <?php if(($jsst_c == 'jssupportticket' && $jsst_layout != 'shortcodes' && $jsst_layout != 'addonstatus') || $jsst_c == 'systemerror' || $jsst_c == 'slug') echo 'active'; ?> menu-item-dashboard">
    ...
    <li class="treeview <?php if($jsst_c == 'ticket' || ($jsst_c == 'fieldordering' && $jsst_ff == 1) || $jsst_c == 'export' || $jsst_c == 'multiform') echo 'active'; ?> menu-item-tickets">
        ...
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            ...
            <?php } else {
                $jsst_plugininfo = JSSTCheckPluginInfo('js-support-ticket-multiform/js-support-ticket-multiform.php');
                $jsst_text = $jsst_plugininfo['availability'] == '1' ? $jsst_plugininfo['text'] : $jsst_plugininfo['text'];
                $jsst_url = $jsst_plugininfo['availability'] == '1' ? 'plugins.php?s=js-support-ticket-multiform&plugin_status=inactive' : 'https://jshelpdesk.com/product/multi-forms/';
                ?>
    ...
    <li class="treeview <?php if($jsst_c == 'department') echo 'active'; ?> menu-item-departments">
        ...
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            <li class="<?php if($jsst_c == 'department' && ($jsst_layout == '')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=department')); ?>" title="<?php echo esc_attr__('Departments', 'js-support-ticket'); ?>"><?php echo esc_html__('Departments', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'department' && ($jsst_layout == 'adddepartment')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=department&jstlay=adddepartment')); ?>" title="<?php echo esc_attr__('Add Department', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Department', 'js-support-ticket'); ?></a></li>
        </ul>
    </li>
    <li class="treeview <?php if($jsst_c == 'priority') echo 'active'; ?> menu-item-priorities">
        ...
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            <li class="<?php if($jsst_c == 'priority' && ($jsst_layout == '')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=priority')); ?>" title="<?php echo esc_attr__('Priorities', 'js-support-ticket'); ?>"><?php echo esc_html__('Priorities', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'priority' && ($jsst_layout == 'addpriority')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=priority&jstlay=addpriority')); ?>" title="<?php echo esc_attr__('Add Priority', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Priority', 'js-support-ticket'); ?></a></li>
        </ul>
    </li>
    <li class="treeview <?php if($jsst_c == 'status') echo 'active'; ?> menu-item-statuses">
        ...
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            <li class="<?php if($jsst_c == 'status' && ($jsst_layout == '')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=status')); ?>" title="<?php echo esc_attr__('Ticket Statuses', 'js-support-ticket'); ?>"><?php echo esc_html__('Ticket Statuses', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'status' && ($jsst_layout == 'addstatus')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=status&jstlay=addstatus')); ?>" title="<?php echo esc_attr__('Add Status', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Ticket Status', 'js-support-ticket'); ?></a></li>
        </ul>
    </li>
    ...
    <?php if(in_array('cannedresponses', jssupportticket::$_active_addons)){ ?>
        <li class="treeview <?php if($jsst_c == 'cannedresponses') echo 'active'; ?> menu-item-cannedresponses">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if($jsst_c == 'cannedresponses' && $jsst_layout == '') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=cannedresponses')); ?>" title="<?php echo esc_attr__('Canned Responses', 'js-support-ticket'); ?>"><?php echo esc_html__('Canned Responses', 'js-support-ticket'); ?></a></li>
                <li class="<?php if($jsst_c == 'cannedresponses' && $jsst_layout == 'addpremademessage') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=cannedresponses&jstlay=addpremademessage')); ?>" title="<?php echo esc_attr__('Add Canned Response', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Canned Response', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } else { ?>
    ...
    <?php if(in_array('agent', jssupportticket::$_active_addons)){ ?>
        <li class="treeview <?php if($jsst_c == 'agent' || $jsst_c == 'agentautoassign') echo 'active'; ?> menu-item-agents">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                ...
                <li class="<?php if($jsst_c == 'agent' && $jsst_layout == 'addstaff') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=agent&jstlay=addstaff')); ?>" title="<?php echo esc_attr__('Add Agent', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Agent', 'js-support-ticket'); ?></a></li>
                <?php if (in_array('agentautoassign', jssupportticket::$_active_addons)) { ?>
                <li class="<?php if($jsst_c == 'agentautoassign') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=agentautoassign')); ?>" title="<?php echo esc_attr__('Agent Auto Assign', 'js-support-ticket'); ?>"><?php echo esc_html__('Agent Auto Assign', 'js-support-ticket'); ?></a></li>
                <?php } else {
                    $jsst_plugininfo = JSSTCheckPluginInfo('js-support-ticket-agentautoassign/js-support-ticket-agentautoassign.php');
                    $jsst_text = $jsst_plugininfo['availability'] == '1' ? $jsst_plugininfo['text'] : $jsst_plugininfo['text'];
                    $jsst_url = $jsst_plugininfo['availability'] == '1' ? 'plugins.php?s=js-support-ticket-agentautoassign&plugin_status=inactive' : 'https://jshelpdesk.com/product/agentautoassign/';
                    ?>
                    <li class="disabled-menu">
        ...
        <li class="treeview <?php if($jsst_c == 'role') echo 'active'; ?> menu-item-roles">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if($jsst_c == 'role' && $jsst_layout == '') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=role')); ?>" title="<?php echo esc_attr__('Agent Roles', 'js-support-ticket'); ?>"><?php echo esc_html__('Agent Roles', 'js-support-ticket'); ?></a></li>
                <li class="<?php if($jsst_c == 'role' && $jsst_layout == 'addrole') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=role&jstlay=addrole')); ?>" title="<?php echo esc_attr__('Add Role', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Agent Role', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } else { ?>
        ...
        <li class="disabled-menu treeview menu-item-roles">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if ($jsst_c == 'role' && ($jsst_layout == '')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=role')); ?>" title="<?php echo esc_attr__('Agent Roles', 'js-support-ticket'); ?>"><?php echo esc_html__('Agent Roles', 'js-support-ticket'); ?></a></li>
                <li class="<?php if ($jsst_c == 'role' && ($jsst_layout == 'addrole')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=role&jstlay=addrole')); ?>" title="<?php echo esc_attr__('Add Agent Role', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Agent Role', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } ?>
    <li class="menu-header"><?php echo esc_html__('Configuration', 'js-support-ticket'); ?></li>
    <li class="treeview <?php if($jsst_c == 'configuration') echo 'active'; ?> menu-item-configurations">
    ...
    <li class="treeview <?php if($jsst_c == 'zywrap' || $jsst_layout == 'admin_zywrap_settings' || $jsst_layout == 'admin_zywrap_playground' || $jsst_layout == 'zywrap_logs' || $jsst_layout == 'zywrap_errors') echo 'active'; ?> menu-item-zywrap">
        <a href="#" title="<?php echo esc_attr__('Zywrap AI', 'js-support-ticket'); ?>">
            ...
            <span class="jsst_text"><?php echo esc_html__('Zywrap AI', 'js-support-ticket'); ?></span>
        </a>
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            <li class="<?php if($jsst_layout == 'zywrap') echo 'active'; ?>">
                <a href="<?php echo esc_url(admin_url('admin.php?page=zywrap&jstlay=zywrap')); ?>" title="<?php echo esc_attr__('Zywrap Dashboard', 'js-support-ticket'); ?>"><?php echo esc_html__('Zywrap Dashboard', 'js-support-ticket'); ?></a>
            </li>
            <li class="<?php if($jsst_layout == 'zywrap_settings' || $jsst_layout == 'admin_zywrap_settings') echo 'active'; ?>">
                <a href="<?php echo esc_url(admin_url('admin.php?page=zywrap&jstlay=zywrap_settings')); ?>" title="<?php echo esc_attr__('Settings', 'js-support-ticket'); ?>"><?php echo esc_html__('Settings', 'js-support-ticket'); ?></a>
            </li>
            <li class="<?php if($jsst_layout == 'zywrap_playground' || $jsst_layout == 'admin_zywrap_playground') echo 'active'; ?>">
                <a href="<?php echo esc_url(admin_url('admin.php?page=zywrap&jstlay=zywrap_playground')); ?>" title="<?php echo esc_attr__('Playground', 'js-support-ticket'); ?>"><?php echo esc_html__('Playground', 'js-support-ticket'); ?></a>
            </li>
            <li class="<?php if($jsst_layout == 'zywrap_logs' || $jsst_layout == 'admin_zywrap_logs') echo 'active'; ?>">
                <a href="<?php echo esc_url(admin_url('admin.php?page=zywrap&jstlay=zywrap_logs')); ?>" title="<?php echo esc_attr__('Audit Logs', 'js-support-ticket'); ?>"><?php echo esc_html__('Audit Logs', 'js-support-ticket'); ?></a>
            </li>
            <li class="<?php if($jsst_layout == 'zywrap_errors' || $jsst_layout == 'admin_zywrap_errors') echo 'active'; ?>">
                <a href="<?php echo esc_url(admin_url('admin.php?page=zywrap&jstlay=zywrap_errors')); ?>" title="<?php echo esc_attr__('API Errors', 'js-support-ticket'); ?>"><?php echo esc_html__('API Errors', 'js-support-ticket'); ?></a>
            </li>
        </ul>
    </li>
    ...
    <li class="treeview <?php if($jsst_c == 'premiumplugin' || $jsst_layout == 'addonstatus') echo 'active'; ?> menu-item-addons">
        ...
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            <li class="<?php if($jsst_c == 'premiumplugin' && ($jsst_layout == 'step1' || $jsst_layout == 'step2' || $jsst_layout == 'step3')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=premiumplugin&jstlay=step1')); ?>" title="<?php echo esc_attr__('Install Addons', 'js-support-ticket'); ?>"><?php echo esc_html__('Install Addons', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'jssupportticket' && $jsst_layout == 'addonstatus') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=jssupportticket&jstlay=addonstatus')); ?>" title="<?php echo esc_attr__('Addons Status', 'js-support-ticket'); ?>"><?php echo esc_html__('Addons Status', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'premiumplugin' && $jsst_layout == 'updatekey') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=premiumplugin&jstlay=updatekey')); ?>" title="<?php echo esc_attr__('Update Key', 'js-support-ticket'); ?>"><?php echo esc_html__('Update Key', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'premiumplugin' && $jsst_layout == 'addonfeatures') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=premiumplugin&jstlay=addonfeatures')); ?>" title="<?php echo esc_attr__('Addons List', 'js-support-ticket'); ?>"><?php echo esc_html__('Addons List', 'js-support-ticket'); ?></a></li>
        </ul>
    </li>
    ...
    <?php if(in_array('knowledgebase', jssupportticket::$_active_addons)){ ?>
        <li class="treeview <?php if($jsst_c == 'knowledgebase' && ($jsst_layout == 'listcategories' || $jsst_layout == 'addcategory')) echo 'active'; ?> menu-item-categories">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if($jsst_c == 'knowledgebase' && $jsst_layout == 'listcategories') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=knowledgebase&jstlay=listcategories')); ?>" title="<?php echo esc_attr__('Categories', 'js-support-ticket'); ?>"><?php echo esc_html__('Categories', 'js-support-ticket'); ?></a></li>
                <li class="<?php if($jsst_c == 'knowledgebase' && $jsst_layout == 'addcategory') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=knowledgebase&jstlay=addcategory')); ?>" title="<?php echo esc_attr__('Add Category', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Category', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
        <li class="treeview <?php if($jsst_c == 'knowledgebase' && ($jsst_layout == 'listarticles' || $jsst_layout == 'addarticle')) echo 'active'; ?> menu-item-kb">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if($jsst_c == 'knowledgebase' && $jsst_layout == 'listarticles') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=knowledgebase&jstlay=listarticles')); ?>" title="<?php echo esc_attr__('Knowledge Base', 'js-support-ticket'); ?>"><?php echo esc_html__('Knowledge Base', 'js-support-ticket'); ?></a></li>
                <li class="<?php if($jsst_c == 'knowledgebase' && $jsst_layout == 'addarticle') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=knowledgebase&jstlay=addarticle')); ?>" title="<?php echo esc_attr__('Add Knowledge Base', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Knowledge Base', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } else { ?>
    ...
    <?php if(in_array('faq', jssupportticket::$_active_addons)){ ?>
        <li class="treeview <?php if($jsst_c == 'faq') echo 'active'; ?> menu-item-faqs">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if($jsst_c == 'faq' && $jsst_layout == '') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=faq')); ?>" title="<?php echo esc_attr__('FAQ\'s', 'js-support-ticket'); ?>"><?php echo esc_html__('FAQ\'s', 'js-support-ticket'); ?></a></li>
                <li class="<?php if($jsst_c == 'faq' && $jsst_layout == 'addfaq') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=faq&jstlay=addfaq')); ?>" title="<?php echo esc_attr__('Add FAQ', 'js-support-ticket'); ?>"><?php echo esc_html__('Add FAQ', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } else { ?>
    ...
    <?php if(in_array('announcement', jssupportticket::$_active_addons)){ ?>
        <li class="treeview <?php if($jsst_c == 'announcement') echo 'active'; ?> menu-item-announcements">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if($jsst_c == 'announcement' && $jsst_layout == '') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=announcement')); ?>" title="<?php echo esc_attr__('Announcements', 'js-support-ticket'); ?>"><?php echo esc_html__('Announcements', 'js-support-ticket'); ?></a></li>
                <li class="<?php if($jsst_c == 'announcement' && $jsst_layout == 'addannouncement') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=announcement&jstlay=addannouncement')); ?>" title="<?php echo esc_attr__('Add Announcement', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Announcement', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } else { ?>
    ...
    <?php if(in_array('download', jssupportticket::$_active_addons)){ ?>
        <li class="treeview <?php if($jsst_c == 'download') echo 'active'; ?> menu-item-download">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if($jsst_c == 'download' && $jsst_layout == '') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=download')); ?>" title="<?php echo esc_attr__('Downloads', 'js-support-ticket'); ?>"><?php echo esc_html__('Downloads', 'js-support-ticket'); ?></a></li>
                <li class="<?php if($jsst_c == 'download' && $jsst_layout == 'adddownload') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=download&jstlay=adddownload')); ?>" title="<?php echo esc_attr__('Add Download', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Download', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } else { ?>
    ...
    <li class="treeview <?php if($jsst_c == 'emailtemplate') echo 'active'; ?> menu-item-emailtemplates">
        ...
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            <li class="<?php if($jsst_c == 'emailtemplate' && $jsst_for == 'tk-nw') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailtemplate&for=tk-nw')); ?>" title="<?php echo esc_attr__('New Ticket', 'js-support-ticket'); ?>"><?php echo esc_html__('New Ticket', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'emailtemplate' && $jsst_for == 'sntk-tk') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailtemplate&for=sntk-tk')); ?>" title="<?php echo esc_attr__('Agent Ticket', 'js-support-ticket'); ?>"><?php echo esc_html__('Agent Ticket', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'emailtemplate' && $jsst_for == 'ew-sm') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailtemplate&for=ew-sm')); ?>" title="<?php echo esc_attr__('New Agent', 'js-support-ticket'); ?>"><?php echo esc_html__('New Agent', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'emailtemplate' && $jsst_for == 'rs-tk') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailtemplate&for=rs-tk')); ?>" title="<?php echo esc_attr__('Reassign Ticket', 'js-support-ticket'); ?>"><?php echo esc_html__('Reassign Ticket', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'emailtemplate' && $jsst_for == 'cl-tk') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailtemplate&for=cl-tk')); ?>" title="<?php echo esc_attr__('Close Ticket', 'js-support-ticket'); ?>"><?php echo esc_html__('Close Ticket', 'js-support-ticket'); ?></a></li>
            ...
            <li class="<?php if($jsst_c == 'emailtemplate' && $jsst_for == 'tk-ew-ad') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailtemplate&for=tk-ew-ad')); ?>" title="<?php echo esc_attr__('New Ticket Admin Alert', 'js-support-ticket'); ?>"><?php echo esc_html__('New Ticket Admin Alert', 'js-support-ticket'); ?></a></li>
            ...
            <li class="<?php if($jsst_c == 'emailtemplate' && $jsst_for == 'no-rp') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailtemplate&for=no-rp')); ?>" title="<?php echo esc_attr__('User Reply On Closed Ticket', 'js-support-ticket'); ?>"><?php echo esc_html__('User Reply On Closed Ticket', 'js-support-ticket'); ?></a></li>
        </ul>
    </li>
    <?php if(in_array('emailpiping', jssupportticket::$_active_addons)){ ?>
        <li class="treeview <?php if($jsst_c == 'emailpiping') echo 'active'; ?> menu-item-emailpiping">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if($jsst_c == 'emailpiping') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailpiping')); ?>" title="<?php echo esc_attr__('Email Piping', 'js-support-ticket'); ?>"><?php echo esc_html__('Email Piping', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } else { ?>
    ...
    <?php if(in_array('mail', jssupportticket::$_active_addons)){ ?>
        <li class="treeview <?php if($jsst_c == 'mail') echo 'active'; ?> menu-item-mail">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if ($jsst_c == 'mail') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=mail')); ?>" title="<?php echo esc_attr__('Mail', 'js-support-ticket'); ?>"><?php echo esc_html__('Mail', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } else { ?>
    ...
    <?php if(in_array('emailcc', jssupportticket::$_active_addons)){ ?>
        <li class="treeview <?php if($jsst_c == 'emailcc') echo 'active'; ?> menu-item-emailcc">
            ...
            <ul class="jsstadmin-sidebar-submenu treeview-menu">
                <li class="<?php if($jsst_c == 'emailcc' && $jsst_layout != 'addemailcc') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailcc')); ?>" title="<?php echo esc_attr__('Email CC', 'js-support-ticket'); ?>"><?php echo esc_html__('Email CC', 'js-support-ticket'); ?></a></li>
                <li class="<?php if($jsst_c == 'emailcc' && $jsst_layout == 'addemailcc') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=emailcc&jstlay=addemailcc')); ?>" title="<?php echo esc_attr__('Add Email CC', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Email CC', 'js-support-ticket'); ?></a></li>
            </ul>
        </li>
    <?php } else { ?>
    ...
    <li class="treeview <?php if($jsst_c == 'product') echo 'active'; ?> menu-item-products">
        ...
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            <li class="<?php if($jsst_c == 'product' && $jsst_layout == '') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=product')); ?>" title="<?php echo esc_attr__('Products', 'js-support-ticket'); ?>"><?php echo esc_html__('Products', 'js-support-ticket'); ?></a></li>
            <li class="<?php if($jsst_c == 'product' && $jsst_layout == 'addproduct') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=product&jstlay=addproduct')); ?>" title="<?php echo esc_attr__('Add Product', 'js-support-ticket'); ?>"><?php echo esc_html__('Add Product', 'js-support-ticket'); ?></a></li>
        </ul>
    </li>
    <li class="menu-header"><?php echo esc_html__('System & Settings', 'js-support-ticket'); ?></li>
    <li class="treeview <?php if($jsst_c == 'jssupportticket' && $jsst_layout == 'shortcodes') echo 'active'; ?> menu-item-shortcodes">
        ...
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            <li class="<?php if($jsst_c == 'jssupportticket' && $jsst_layout == 'shortcodes') echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=jssupportticket&jstlay=shortcodes')); ?>" title="<?php echo esc_attr__('Shortcodes', 'js-support-ticket'); ?>"><?php echo esc_html__('Shortcodes', 'js-support-ticket'); ?></a></li>
        </ul>
    </li>
    <li class="treeview <?php if($jsst_c == 'themes') echo 'active'; ?> menu-item-themes">
    ...
    <li class="treeview <?php if($jsst_c == 'reports') echo 'active'; ?> menu-item-reports">
        ...
        <ul class="jsstadmin-sidebar-submenu treeview-menu">
            ...
            <?php if(in_array('feedback', jssupportticket::$_active_addons)){ ?>
            <li class="<?php if($jsst_c == 'reports' && ($jsst_layout == 'satisfactionreport')) echo 'active'; ?>"><a href="<?php echo esc_url(admin_url('admin.php?page=reports&jstlay=satisfactionreport')); ?>" title="<?php echo esc_attr__('Satisfaction Report', 'js-support-ticket'); ?>"><?php echo esc_html__('Satisfaction Report', 'js-support-ticket'); ?></a></li>
            <?php } ?>
        </ul>
    </li>
